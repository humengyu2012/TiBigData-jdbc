...
public class TiDBSourceSplitEnumerator
  ...
  public TiDBSourceSplitEnumerator(
      List<TiDBSourceSplit> splits, long version, SplitEnumeratorContext<TiDBSourceSplit> context) {
  ...
  public TiDBSourceSplitEnumState snapshotState(long checkpointId) throws Exception {
    return new TiDBSourceSplitEnumState(new ArrayList<>(remainingSplits));
  }
